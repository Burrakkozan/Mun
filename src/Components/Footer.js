...
import {  AiFillMediumCircle , AiFillBehanceSquare} from "react-icons/ai";
const Footer = () => {
  return (
    <>
      <section className="content footer">
          ...
          <p className="credits">
            ...
            All of {" "}
            <a href="https://medium.com/@burrakkozcaan/hoodie-pattern-design-cfebc4b05f1f" target="_blank">
            <AiFillMediumCircle size={20}/>
            </a>
            <a href='https://www.behance.net/burrakozcaan' target="_blank">
            <AiFillBehanceSquare  size={20}/>
            </a>
            <br /> Crafted by <a href='https://www.instagram.com/burrakozcaan/' >@burakozcan</a>
